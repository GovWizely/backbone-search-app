...
3. Copy the fonts into [src/fonts](../src/fonts).
4. Add the new icon as css class in [src/scss/_font.scss](../src/scss/_font.scss).

To use the icons, add the css class to the DOM element, i.e.:
